...
{
	ros::init(argc, argv, "car_ctl_node"); 
	ros::NodeHandle n("~");
    ...
    double t_pos_x_4[6] = {2.2, 0, 0, -6.5, -6.2, -11};  //4个目标点的声明
    double t_pos_y_4[6] = {2, 2, 7.5, 7.5, 2.5, 2.5};  
    ...
    while(ros::ok())
    {
        ...
        try
        {
            listener0.transformPoint("base_link", map0, map0_t);
